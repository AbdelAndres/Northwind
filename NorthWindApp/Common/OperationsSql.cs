...
namespace Univalle.Fie.Sistemas.BaseDeDatos2.NorthWindApp.Common
{
    /// <summary>
    ...
    public class OperationsSql
    {
        ...
        public static string _connectionString = ConfigurationManager.ConnectionStrings["CustomersConnectionString"].ConnectionString;
        ...
        public static byte ExecuteBasicCommandCount(SqlCommand cmd)
        {
            ...
            {
                Operations.WriteLogsRelease("Methods", "SqlException in ExecuteBasicCommandCount", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExecuteBasicCommandCount(SqlCommand cmd)", ex);
            }
            catch (Exception ex)
            {
                Operations.WriteLogsRelease("Methods", "Exception in ExecuteBasicCommandCount", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExecuteBasicCommandCount(SqlCommand cmd)", ex);
            }
            finally
            {
        ...
        public static DataTable ExcecuteDataTableCommand(SqlCommand cmd)
        {
            ...
            {
                Operations.WriteLogsRelease("Methods", "SqlException in ExcecuteDataTableCommand", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExcecuteDataTableCommand(SqlCommand cmd)", ex);
            }
            catch (Exception ex)
            {
                Operations.WriteLogsRelease("Methods", "Exception in ExcecuteDataTableCommand", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExcecuteDataTableCommand(SqlCommand cmd)", ex);
            }
        ...
        public static SqlDataReader ExecuteDataReaderCommand(SqlCommand cmd)
        {
            ...
            {
                Operations.WriteLogsRelease("Methods", "SqlException in ExcecuteDataReaderCommand", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExecuteDataReaderCommand(SqlCommand cmd)", ex);
            }
            catch (Exception ex)
            {
                Operations.WriteLogsRelease("Methods", "Exception in ExcecuteDataReaderCommand", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExecuteDataReaderCommand(SqlCommand cmd)", ex);
            }
            return res;
        }
        ...
        public static string ExcecuteScalarCommand(SqlCommand cmd)
        {
            ...
            {
                Operations.WriteLogsRelease("Methods", "SqlException in ExcecuteScalarCommand", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExcecuteScalarCommand(SqlCommand cmd)", ex);
            }
            catch (Exception ex)
            {
                Operations.WriteLogsRelease("Methods", "Exception in ExcecuteScalarCommand", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExcecuteScalarCommand(SqlCommand cmd)", ex);
            }
            finally
            {
        ...
        public static int GetNextIdTable(string tabla)
        {
            ...
            {
                Operations.WriteLogsRelease("Methods", "SqlException in GetNextIDTable", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método GetNextIdTable(string tabla)", ex);
            }
            catch (Exception ex)
            {
                Operations.WriteLogsRelease("Methods", "Exception in GetNextIDTable", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método GetNextIdTable(string tabla)", ex);
            }
            return res;
        }
        ...
        public static int GetActIdTable(string tabla)
        {
            ...
            {
                Operations.WriteLogsRelease("Methods", "SqlException in GetActIDTable", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método GetActIdTable(string tabla)", ex);
            }
            catch (Exception ex)
            {
                Operations.WriteLogsRelease("Methods", "Exception in GetActIDTable", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método GetActIdTable(string tabla)", ex);
            }
            return res;
        }
        ...
        public static void ExecuteNBasicCommand(List<SqlCommand> cmds)
        {
            ...
            {
                tran.Rollback();
                Operations.WriteLogsRelease("Methods", "SqlException in ExecuteNBasicCommand", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExecuteNBasicCommand(List<SqlCommand> cmds)", ex);
            }
            catch (Exception ex)
            {
                tran.Rollback();
                Operations.WriteLogsRelease("Methods", "Exception in ExecuteNBasicCommand", string.Format("{0} {1}", ex.Message, ex.StackTrace));
                throw new Exception("Se ha producido un error en el método ExecuteNBasicCommand(List<SqlCommand> cmds)", ex);
            }
            finally
            {
